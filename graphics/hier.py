...
pgm.add_edge("betab", "Fb")
pgm.add_edge("Fb", "Nb")
pgm.add_node(daft.Node("hyperprior", "hyper\nprior", 0.3, 1.4, offset=[0,5], fixed=True))
pgm.add_node(daft.Node("phistar", r"$\phi^\ast$", 1.0, 1.95))
pgm.add_node(daft.Node("Lstar", r"$L^\ast$", 1.0, 1.4))
pgm.add_node(daft.Node("alpha", r"$\alpha$", 1.0, 0.85))
pgm.add_node(daft.Node("Lg", r"$L_{g,i}$", 1.9, 1.4))
pgm.add_node(daft.Node("Ns", r"$N_{s,i}$", 2.8, 1.4, observed=True))
pgm.add_edge("hyperprior", "phistar")
pgm.add_edge("hyperprior", "Lstar")
pgm.add_edge("hyperprior", "alpha")
pgm.add_edge("phistar", "Lg")
